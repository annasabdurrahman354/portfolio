...
const FluidBackground: React.FC = () => {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden bg-[#F7F4EB]">
      ...
      {/* Decorative Vector Elements (Subtle Grids) */}
      <div 
      ...
      {/* Occasional Floating "Stars" (Retro 4-point) */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {[...Array(6)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute text-ink-black/10"
            style={{
              top: `${Math.random() * 100}%`,
